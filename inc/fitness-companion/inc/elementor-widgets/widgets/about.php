 ...
 * @since 1.0
 */
class Fitness_About extends Widget_Base {

	public function get_name() {
		return 'fitness-about';
	}

	public function get_title() {
		return __( 'About', 'fitness' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'description'   => esc_html__('Use <br> tag for line break', 'fitness'),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => __( 'Who we are <br> to Serve the nation', 'fitness' )
            ]
        );
        $this->add_control(
            'description',
            [
                ...
                'label_block'   => true,
                'default'       => __( 'inappropriate behavior is often laughed off as boys will be boys, women face higher conduct standards especially in the workplace. That\'s why it\'s crucial that, as women, our behavior on the job is beyond reproach.', 'fitness' )
            ]
        );
        $this->add_control(
            'about_features_content', [
                'label' => __( 'Create Features', 'fitness' ),
		...
		$this->add_control(
			'fontsize',
			[
				'label' => __( 'Icon Font Size', 'fitness' ),
        ...
        $this->add_control(
            'color_featuretitle', [
                'label'     => __( 'Feature Title Color', 'fitness' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
                    ...
                    <div class="row no-gutters">
                        ...
                        foreach( $settings['about_features_content'] as $val ): ?>
                            <div class="single-services col">
                                ...
                                // Description
                                if( ! empty( $val['desc'] ) ) {
                                    echo fitness_get_textareahtml_output( $val['desc'] );
                                }
                                ?>
                            </div>
                            <?php
