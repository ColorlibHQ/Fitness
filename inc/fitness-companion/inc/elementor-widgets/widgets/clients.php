...
class Fitness_Clients extends Widget_Base {

	public function get_name() {
		return 'fitness-clients';
	}

	public function get_title() {
		return __( 'Clients', 'fitness' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'clients_content',
			[
				'label' => __( 'Clients', 'fitness' ),
			]
		);
		$this->add_control(
            'clients', [
                'label' => __( 'Client', 'fitness' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Client Url', 'fitness' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => '#'
                    ],
                    [
                        'name'  => 'img',
                        'label' => __( 'Client Logo', 'fitness' ),
