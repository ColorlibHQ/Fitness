 ...
 * @since 1.0
 */
class Fitness_Features extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'fitness' ),
            ]
        );
        $this->add_control(
            'sect_title', [
            ...
            'features_content', [
                ...
                'fields' => [
                    [
                        ...
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => esc_html__( 'Smart Security', 'fitness' )
                    ],
                    [
                        'name'  => 'description',
                        ...
                        'type'  => Controls_Manager::TEXTAREA,
                        'label_block' => true,
                        'default' => esc_html__( 'inappropriate behavior is often laughed off as boys will be boys, women face higher conduct women face higher conduct.', 'fitness' )
                    ]
                ],
            ]
		);
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'fitness' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            <div class="container">
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6 feature-left">
                        <?php if( $f_image ){
                            echo '<img class="img-fluid" src="'. esc_url( $f_image ) .'" alt="'.esc_html__( 'feature image', 'fitness' ).'">';
                        }?>
                    </div>
