 ...
 * @since 1.0
 */
class Fitness_Pricing extends Widget_Base {

	public function get_name() {
		return 'fitness-pricing';
	}

	public function get_title() {
		return __( 'Pricing Table', 'fitness' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'pricing_heading',
			[
				'label' => __( 'Pricing Section Heading', 'fitness' ),
			]
		);
		$this->add_control(
			'sect_title', [
		...
		$this->add_control(
			'pricing_table', [
				'label' => __( 'Create Pricing Table', 'fitness' ),
				'type'  => Controls_Manager::REPEATER,
				'title_field' => '{{{ table_heading }}}',
				'fields' => [
					[
						'name'  => 'table_heading',
						'label' => __( 'Table heading', 'fitness' ),
						'type'  => Controls_Manager::TEXT,
						'label_block' => true,
						'default' => 'Real basic'
					],
                    ...
                    [
                        'name'  => 'price',
                        'label' => __( 'Table price', 'fitness' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => '39'
                    ],
                    [
                        'name'  => 'monthoryear',
	                    'label' => __( 'Monthly/Yearly', 'fitness' ),
		...
		$this->add_control(
			'color_btn_label', [
				'label'     => __( 'Pricing Button Label Color', 'fitness' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#fff',
				'selectors' => [
		...
		$this->add_control(
			'color_btn_bg', [
				'label'     => __( 'Pricing Button Background Color', 'fitness' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#3bacf0',
				'selectors' => [
		...
		$this->add_control(
			'color_btn_hover_bg', [
				'label'     => __( 'Pricing Button Hover Background', 'fitness' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#88d200',
				'selectors' => [
                            ...
                            <div class="single-price no-padding">
	                            ...
	                            <?php
                                    if( ! empty( $pricing['pricing_list'] ) ) {
                                        echo fitness_get_textareahtml_output( $pricing['pricing_list'] );
                                    }
	                            ?>
                                ...
                                <div class="price-bottom">
                                    <div class="price-wrap d-flex flex-row justify-content-center">
	                                    ...
	                                    ?>
                                        <span class="time"><?php echo esc_html__('Per', 'fitness'); ?><br>
