...
class Fitness_Enqueue {

	public $scripts = array();

	public function fitness_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'fitness_frontend_enqueue_scripts', ) );
	}

	public function fitness_frontend_enqueue_scripts( ) {
