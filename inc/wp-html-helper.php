...
// image default alt
if( ! function_exists( 'fitness_img_default_alt' ) ) {
	function fitness_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'fitness_img_tag' ) ) {
	function fitness_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = fitness_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'fitness_anchor_tag' ) ) {
	function fitness_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'fitness' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'fitness_heading_tag' ) ) {
	function fitness_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'fitness' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'fitness_paragraph_tag' ) ) {
	function fitness_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'fitness_other_tag' ) ) {
	function fitness_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'fitness_button_element ' ) ) {
	function fitness_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'fitness' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
