<?php 
	...
	<div class="footer-bottom row align-items-center">
		<p class="footer-text m-0 col-lg-6 col-md-12"><?php echo wp_kses_post( fitness_opt( 'fitness-copyright-text-settings', $copyText ) ); ?></p>
		<?php
            if( has_nav_menu( 'social-menu' ) ) {
                echo '<div class="col-lg-6 col-sm-12 footer-social">';
                    $args = array(
                        ...
                        'fallback_cb'    => 'fitness_social_navwalker::fallback',
                        'walker'         => new fitness_social_navwalker(),
                    );  
                    wp_nav_menu( $args );
                echo '</div>';
            }
