...
<div id="<?php the_ID(); ?>" <?php post_class( esc_attr( 'single-post row' ) ); ?>>
    ...
    <div class="col-lg-3  col-md-3 meta-details">
        ...
        <div class="user-details row">
             ...
             * and biography
             * @Hook  fitness_blog_single_meta
             *
             * @Hooked fitness_blog_single_meta_cb
             *
             *
             */
            do_action( 'fitness_blog_single_meta' );
            ?>
        </div>
    </div>
	...
	echo '<div class="col-lg-9 col-md-9 blog-detail-txt">';
        ...
        /**
         * Blog post title
         * @Hook  fitness_blog_posts_content
         *
	 ...
	 * @Hook  fitness_blog_posts_content
	 *
	 * @Hooked fitness_blog_posts_content_cb
	 * 
	 *
	 */
	do_action( 'fitness_blog_posts_content' );
...
/**
 * Blog single page content 
 * @Hook  fitness_blog_single_footer_nav
 *
 * @Hooked fitness_blog_single_footer_nav_cb
 * 
 *
 */
do_action( 'fitness_blog_single_footer_nav' );
